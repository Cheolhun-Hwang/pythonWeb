...
cursor.execute("SELECT count(emp_id) from employee_tbl WHERE emp_id = '" + idv + "'")
...
if idvalue  == 0 :
    ...
    connection.commit()
    cursor.execute("INSERT INTO employee_tbl VALUES('" + idv + "','" + password  + "','" + name + "','" + telephone + "','" + address + "','99')")
